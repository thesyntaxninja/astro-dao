...
// We grab our token module contract address "ERC 20 address"
const tokenModule = sdk.getTokenModule(
    "0xd5BF923b6a4AF7FECA419BDCAe68933344B63ecd"
);

// We grab our vote module contract address "treasury"
...
const App = () => {
    ...
    // State variables for voting mechanism.
    ...
    const mintNft = () => {
        ...
        return (
            <div className="mint-nft">
                <h1>Mint your free AstroDAO Membership NFT</h1>
                <button
                    disabled={isClaiming}
                    onClick={() => mintNft()}
                >
